...
setup(name="h_tats",
      ...
      packages=['api/v1/endpoints','services','api','domain', 'models', 'models/engine', 'repository','domain/client','api/v1/endpoints/occupation',
                ...
                'services/room_service','api/v1/endpoints/room', 'api.v1', 'domain/client', 'api/v1/endpoints/client','services/customer/port','domain/occupation', 'api/v1/endpoints/settlement',
